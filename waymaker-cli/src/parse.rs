...
static ALIASES: &[(&str, &str)] = &[
    ...
    ("h", "header.content"),
    ("nav", "ui.nav.active"),
    ("nav-color", "ui.nav.color"),
    ("nav-bar", "ui.nav.bar"),
    ("nav-marker", "ui.nav.marker"),
    ("nav-prompt", "ui.nav.prompt"),
    ("nav-hints", "ui.nav.hints"),
    ("nav-hints-columns", "ui.nav.hints_columns"),
...
/// The value is broken down into words, and fed into [`waymaker_partial::Set`] to construct the (partial) type at `path`.
