use std::path::Path;
use waymaker::utils::markdown::MarkdownOptions;
...
pub fn render_markdown_content(
    ...
    waymaker::utils::markdown::render_markdown_ansi(&content, opts)
}
...
mod tests {
    ...
    async fn test_watch_direct_write_and_cancel() {
        ...
        let opts = MarkdownOptions {
            ...
            inline_images: false,
            diagram_theme: waymaker::config::DiagramTheme::Auto,
            diagram_background: waymaker::config::DiagramBackground::Transparent,
        };
