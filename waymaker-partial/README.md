...
Support for partial updates and configuration in waymaker. This crate provides traits and logic for merging partial configuration structures, which is useful for overriding default settings with user-defined values.
...
```rust
use waymaker_partial::{Set, Apply};
use waymaker_partial_macros::partial;
